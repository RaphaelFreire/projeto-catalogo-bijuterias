...
describe("AgeRule", () => {
  ...
  test("deve ajustar a idade quando o aniversario ainda nao aconteceu no ano de referencia", () => {
    ...
    // Acesso a método privado só para este teste de borda; a interseção com o tipo da classe
    // confunde o checker quanto à chamada, mas a assinatura é a mesma do método real.
    // eslint-disable-next-line @typescript-eslint/no-unsafe-call, @typescript-eslint/no-unsafe-assignment
    const age = rule.getAgeFromBirthDate(
      new Date(2008, 3, 1),
